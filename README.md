...
src/ ├── model/ │ ├── Vehiculo.java │ ├── Carro.java │ ├── Moto.java │ ├── Camion.java │ ├── Espacio.java │ ├── Parqueadero.java │ ├── Tiquete.java │ ├── DetalleTiquete.java │ └── Registrable.java │ ├── service/ │ └── ParqueaderoService.java │ ├── util/ │ └── CalculadoraTarifa.java │ └── app/ └── App.java
